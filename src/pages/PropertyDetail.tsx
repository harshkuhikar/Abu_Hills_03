...
import { ArrowLeft, MapPin, Bed, Bath, Square, Car, Wifi, Dumbbell, Waves, Shield, Calendar, Phone, Mail, Heart, Share2, Camera } from 'lucide-react';
...
const PropertyDetail: React.FC = () => {
  ...
  const properties = [
    {
      ...
      category: "Penthouse",
      featured: true,
      description: "Experience luxury living at its finest in this stunning penthouse featuring floor-to-ceiling windows, premium finishes, and breathtaking city views. This exceptional property offers an open-concept design with high-end appliances, marble countertops, and custom millwork throughout.",
      yearBuilt: 2020,
      parking: 2,
      lotSize: "N/A",
    ...
    },
    {
      ...
      description: "Beautiful modern family home featuring an open floor plan, gourmet kitchen, and private backyard garden. Perfect for families seeking comfort and style in a quiet neighborhood setting.",
      yearBuilt: 2018,
      parking: 2,
      lotSize: "0.25 acres",
  ...
  const property = properties.find(p => p.id === parseInt(id || '1')) || properties[0];
  ...
  const amenities = [
    ...
    { icon: Wifi, label: 'High-Speed Internet', description: 'Fiber Optic Ready' },
  ...
  const nearbyPlaces = [
    ...
    { name: 'Madison Avenue Shopping', distance: '0.3 miles', type: 'Shopping' }
  ];
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {amenities.map((amenity, index) => (
                  <div key={index} className="flex items-start space-x-4 p-4 bg-gradient-to-br from-luxury-gold/10 to-yellow-500/5 rounded-2xl">
