      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <Link
            to="/"
            className={
              "text-3xl font-serif font-bold hover:scale-105 transition-all duration-300 text-luxury-gold"
            }
          >
            ABU HILLS
          </Link>
          ...
          <button
            ...
            className={`md:hidden p-2 rounded-full transition-all duration-300 text-black hover:text-luxury-gold  hover:bg-luxury-gold/10`}
          >
