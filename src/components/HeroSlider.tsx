  ...
  const slides = [
    {
      ...
      subtitle: 'Premium properties in the most prestigious locations worldwide',
    ...
    <div className="relative h-screen overflow-hidden">
              ...
              <div className="relative h-full flex items-center justify-center">
                <div className="max-w-6xl mx-auto px-4 text-center">
                  <div className="animate-fade-in">
                    ...
                    <p className="text-2xl md:text-3xl text-white/95 mb-12 font-light max-w-4xl mx-auto leading-relaxed animate-slide-up" style={{ animationDelay: '0.3s' }}>
                      {slide.subtitle}
                    </p>
      ...
      <div className="absolute right-8 bottom-12 bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
        <div className="text-center">
          ...
          <div className="text-white/80 text-sm font-medium">Premium Properties</div>
        </div>
      </div>
    </div>
  );
